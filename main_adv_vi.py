...
parser.add_argument('--data', default='cifar100', type=str, help='dataset name')
...
model_out = './checkpoint/' + opt.data+'_'+opt.model+'_'+str(opt.max_norm)+'_adv_vi_beta001.pth'
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(tqdm(trainloader)):
        ...
        loss = elbo(outputs, targets, kl, beta)
        loss.backward()
        optimizer.step()
